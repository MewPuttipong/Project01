					...
					<div class="col-md-6 col-sm-12">
						...
						<nav aria-label="breadcrumb" role="navigation">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page"><a href="{{route('background.index')}}">หน้าจัดการ Background</a></li>
			...
			<div class="row">
                <div class="col-lg-12">
                  <section class="panel">
                    ...
                    แก้ไขข้อมูล Background
                    </header>
					<br>
                    <div class="panel-body">
						<form role="form" action="{{url('admin/background/update/'.$background->id_bg)}}" method="post" enctype="multipart/form-data">
						@csrf
						...
						<div class="form-group">
							<img src="{{asset('admin/images/'.$background->image)}}" alt="" id="showImage" style="width: 150px">
