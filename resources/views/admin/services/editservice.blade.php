					...
					<div class="col-md-6 col-sm-12">
						...
						<nav aria-label="breadcrumb" role="navigation">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page"><a href="{{route('service.index')}}">หน้าจัดการ Services</a></li>
                ...
                <div class="col-lg-12">
                  <section class="panel">
                    ...
                    <div class="panel-body">
                      <form role="form" action="{{url('admin/service/update/'.$editservice->id_service)}}" method="post">
						@csrf
                        <div class="form-group">
                            <label for="exampleInputText">ชื่องานบริการ</label>
                            <input type="text" class="form-control" id="exampleInputText" name="name" value="{{$editservice->servicename}}">
                          </div>
                        <div class="form-group">
                          <label for="exampleInputText">เนื้อหา</label>
                          <input type="text" class="form-control" id="exampleInputText" name="detail" value="{{$editservice->detail}}">
                        </div>
                        <!-- <div class="form-group">
