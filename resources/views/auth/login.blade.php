			...
			<div class="wrap-login100 p-t-85 p-b-20">
				<form class="login100-form validate-form" action="{{ route('login') }}" method="POST">
					...
					<span class="login100-form-avatar">
						<img src="{{asset('back_end/images/avatar-01.png')}}" alt="AVATAR">
					</span>

					<div style="background-color: white" class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Enter username">
						<input class="input100" type="text" name="username">
						<span class="focus-input100" data-placeholder="Username"></span>
					</div>

					<div style="background-color: white" class="wrap-input100 validate-input m-b-50" data-validate="Enter password">
...
<!--===============================================================================================-->
	<script src="{{asset('back_end/vendor/animsition/js/animsition.m')}}in.js"></script>
<!--===============================================================================================-->
