  ...
  <div class="d-flex" id="wrapper">
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="{{url('/admin/content')}}" class="list-group-item list-group-item-action bg-light">Content</a>
        <a href="{{url('/admin/service')}}" class="list-group-item list-group-item-action bg-light">Service</a>
        <a href="{{url('/admin/category')}}" class="list-group-item list-group-item-action bg-light">Category</a>
